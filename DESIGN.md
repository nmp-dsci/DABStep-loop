# DESIGN.md — the brief DABstep-loop is built to
...
| `nmp-dsci.github.io/_projects/dabstep-loop.md` | the eventual case study | the site's own contract applies, run `scripts/lint_case_study.py` there |
